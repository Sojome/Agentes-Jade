 ...
 */
public class CrearcionAgentesAirpollution {
    ...
    public static void main(String args[]) throws StaleProxyException {
        ...
        try {
            ...
            rma = mainContainer.createNewAgent("temp", "Airpollution.AgenteTemperatura", new Object[0]);

            rme = mainContainer.createNewAgent("hume", "Airpollution.AgenteHumedad", new Object[0]);

            rmi = mainContainer.createNewAgent("mono", "Airpollution.AgenteCarbonoMonoxido", new Object[0]);

            rmo = mainContainer.createNewAgent("dio", "Airpollution.AgenteCarbonoDioxido", new Object[0]);

            rmu = mainContainer.createNewAgent("air", "Airpollution.AgenteAirPollution", new Object[0]);
