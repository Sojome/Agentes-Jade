...
//-gui -port 1098 juan:Tareaprotocolos.ProposeReceptor;pedro:Tareaprotocolos.ProposeEmisor
public class ProposeReceptor extends Agent {
    ...
    private class ResponderSalirClase extends ProposeResponder {
        ...
        protected ACLMessage prepareResponse(ACLMessage propuesta)
            ...
            if (ProposeReceptor.this.checkContent(propuesta.getSender().getLocalName(), propuesta.getContent())) {
                //Aceptación de la propuesta.
                System.out.printf("%s: Ahora mismo me pongo a estudiar.\n", this.myAgent.getLocalName());
                ...
                System.out.printf("%s: Me voy a poner a jugar con la consola.\n", this.myAgent.getLocalName());
